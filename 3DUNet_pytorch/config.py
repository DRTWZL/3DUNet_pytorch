...
parser.add_argument('--n_labels', type=int, default=4,help='number of classes') #CTV1，CTV2,GTVnd_L/R
parser.add_argument('--upper', type=int, default=240, help='')
parser.add_argument('--lower', type=int, default=-160, help='')
...
parser.add_argument('--train_path',default = '/home/img/code/3DUNet_pytorch/data/train/',help='fixed trainset root path')
parser.add_argument('--val_path',default = '/home/img/code/3DUNet_pytorch/data/train/',help='fixed trainset root path')
parser.add_argument('--test_data_path',default = '/home/img/code/3DUNet_pytorch/data/train/',help='Testset path')
parser.add_argument('--save',default='3DUNet',help='save path of trained model')
...
parser.add_argument('--crop_sizeXY', type=int, default=256)
parser.add_argument('--crop_sizeZ', type=int, default=8)
